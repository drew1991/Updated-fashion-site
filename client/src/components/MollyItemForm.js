...
//   }
    ...
    return (
        <form onSubmit={handleSubmit}>
            ...
            <button className='button-89' type="submit" variant="outlined">Submit</button>
            <button className='button-89' varient="outlined" onClick={handleDeleteClick}>Delete</button>
        </form>
    )
}